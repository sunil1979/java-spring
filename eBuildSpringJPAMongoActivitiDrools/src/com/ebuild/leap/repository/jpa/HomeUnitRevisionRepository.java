...
public interface HomeUnitRevisionRepository extends JpaRepository<HomeUnitRevision, Long> {
	...
	@Query(name="getLatestRevision",value="select * from revision where revision.homeUnitVersion=?1 ORDER BY revision.revisionNumber DESC LIMIT 1",nativeQuery=true)
	public HomeUnitRevision getLatestRevisionId(Long homeUnitVersionId);
